...
axiosSecure.post('/user/create', userInfo).then(res=>{
  ...
  return (
    <div
      className="shadow-lg border border-[#d5d9e0] rounded-xl px-5 h-[50%] flex flex-col justify-center space-y-6 w-[80%] lg:w-[35%]  md:w-[35%] mx-auto py-4 mt-10 mb-10"
      ...
      <form onSubmit={handleSubmit(handleRegister)}>
        ...
        <input
          ...
          {...register("password", {
            ...
            pattern: {
              value: /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d).+$/,
              message: "At least 1 uppercase, 1 lowercase & 1 number required",
            },
          })}
        />
        {errors.password && (
