      ...
      <div className="w-full flex flex-col md:flex-row items-center gap-12 p-8">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          <h2 className="text-2xl font-semibold">
            Delivering <span className="text-primary"> Knowledge</span> Across
            All Districts
          </h2>

          <p className="text-secondary text-xl">
            BookCourier is rapidly expanding its delivery network to ensure your
            favorite books reach you, wherever you are. Check our growing
            service areas!
          </p>
